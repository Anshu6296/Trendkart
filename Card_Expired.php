...
<html>
<head>
    <title>Your Card is Expired </title> 
<style>
.reel-container {
  position: relative;
  width: 540px;
...
<div class="reel-container">
  <div class="reel-content">
    ...
    <h1 class="success-text">Card is Expired</h1>
    
    <p style="font-family: Garamond, sans-serif; font-size: 20px; font-weight: bold; color: #333;">We could not acquire the payment.</p>
    <p style="font-family: Courier, sans-serif; font-size: 12px; font-weight: bold; color: #333;">(Note: Your Card is Expired, Please try another Card.)<br></p>
